            ...
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    <div className="flex mt-4 sm:justify-center md:mt-0 space-x-6 rtl:space-x-reverse">
                        ...
                        <a href="https://twitter.com/scthakuri" target="_blank" title="Twitter Page" className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
                        ...
                        <a href="https://www.linkedin.com/in/scthakuri/" title="Linkedin Page" target="_blank" className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
                        ...
                        <a href="https://github.com/scthakuri/" title="Github Account" target="_blank" className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
