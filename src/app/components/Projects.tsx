...
export default function Projects() {
    ...
    return (
        <section id="projects" className="bg-white dark:bg-gray-900 pb-10">
            <div className="container mx-auto">
                <div className="max-w-screen-lg mx-auto">
                    <div className="text-center w-full mb-10">
                        <h2 className="mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl lg:text-5xl dark:text-white">Projects</h2>
                ...
                <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <div className="relative transform overflow-hidden rounded-lg bg-white dark:bg-gray-900 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                        <div className="bg-white dark:bg-gray-900 px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                            ...
                            <h5 className="mt-3 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{project?.title}</h5>
                            <p className="mb-4 font-normal text-gray-700 dark:text-gray-400">{project?.date}</p>
                            ...
                            <p className="mb-3 font-normal text-gray-700 dark:text-gray-300">{project?.description}</p>
