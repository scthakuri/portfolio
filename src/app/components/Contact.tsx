            ...
            <div className="container mx-auto">
                <div className="max-w-screen-md mx-auto">
                    <div className="bg-opacity-[3%] bg-dark rounded-md p-11 md:mb-12 lg:mb-5 sm:p-[55px] lg:p-11 xl:p-[55px] wow fadeInUp" data-wow-delay=".15s" style={{
                        ...
                        <p className="text-white text-base font-medium mb-12">Feel free to reach out to me for any questions or opportunities or mail me directly on <a href="mailto:sureshchand12a@gmail.com" className="underline text-blue-700" title="Contact Me">sureshchand12a@gmail.com</a></p>
