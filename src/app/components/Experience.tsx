                        ...
                        <ol className="relative border-s border-gray-700">
                            {
                                experiences.map((edu) => (
                                    <li className="mb-10 ms-6" key={edu.id}>
                                        ...
                                        <h3 className="flex items-center mb-1 text-lg font-semibold text-white">{edu.role} {edu.running && <span className="bg-blue-100 text-blue-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded bg-blue-900 text-blue-300 ms-3">Till Now</span>}</h3>
